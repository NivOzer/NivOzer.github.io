  ...
  return (
    <div id="about" className='min-h-screen'>
      <div class="flex flex-col items-center justify-center min-h-screen">
        ...
        <div class="xs:max-h-[85vh] xs:justify-around  xs:w-full leading-6 border-2 border-dashed shadow-stitched border-romanBeige  bg-white flex flex-col xs:gap-4 gap-6 items-center rounded-lg p-12 w-1/5 text-center">
          
          <div>
            <img class="xs:w-36 xs:h-36 w-40 h-40 object-cover rounded-full" src="/assets/Me.jpg" alt="god" />
          </div>
          ...
          <div className='flex flex-col gap-6 xs:gap-4 items-center'>
            ...
            <button
              ...
              className="xs:w-full xs:p-1 w-1/2 py-2 px-4 text-lg rounded-lg shadow-md bg-gradient-to-br from-yellow-800 via-yellow-600 to-yellow-800 text-amber-50 hover:bg-amber-100 font-serif"
            >
                    Download CV
              </button>
          </div>
